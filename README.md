...
Levels 11+ : All the Probe, Goal, Cyberman Agent and Dalek Spawn Points are randomally distributed all around the Arena, sometimes behind Walls etc. (Sometimes the Dalek may Spwan directly next to the Agent)  Level 11, therfore represents a major shift in challenge.


The GAIL imitation is Trained against a Level 6 environment, where the Dalek is begining to impsoe itself as a threat. 
...
The Agent fails to get beyond level 11. The Agent has a major challenge to sense where the Porbe and Goal areas coudl be. It does not develop any effective search and exploration strategy.  
